...
export default class UmlWebClient {
    ...
    onClient = (clientID) => {
        console.warn('client of id ' + clientID + ' connectected to server. Override UmlWebClient.onClient to keep track of new clients, or to disable this warning message.');
    }
    onSelect = (event) => {
                    ...
                    if (msgObj.client === me.id) {
                        ...
                        me.client.onmessage = (msg) => {
                            ...
                            if (msgData.put || msgData.PUT) {
                                ...
                                me.otherClients.set(clientID, new ClientInfo(msgData.client.color));
