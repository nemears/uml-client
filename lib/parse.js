...
function parsePackageableElement(data, alias, packageableElement) {
    ...
    if (data.owningPackage) {
        packageableElement.set(data.owningPackage);
    }
}
...
function parsePrimitiveType(data, primitiveType) {
    parsePackageableElement(data, primitiveType);
}
