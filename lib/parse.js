...
export function parseType(data, manager) {
if (data.Abstraction) {
        return new Abstraction(manager);
    } else if (data.Association) {
        return new Association(manager);
    } else if (data.Class) {
        return new Class(manager);
    } else if (data.Comment) {
        return new Comment(manager);
    } else if (data.DataType) {
        return new DataType(manager);
    } else if (data.Dependency) {
        return new Dependency(manager);
    } else if (data.Enumeration) {
        return new Enumeration(manager);
    } else if (data.EnumerationLiteral) {
        return new EnumerationLiteral(manager);
    } else if (data.Extension) {
        return new Extension(manager);
    } else if (data.ExtensionEnd) {
        return new ExtensionEnd(manager);
    } else if (data.Generalization) {
        return new Generalization(manager);
    } else if (data.InstanceSpecification) {
        return new InstanceSpecification(manager);
    } else if (data.InstanceValue) {
        return new InstanceValue(manager);
    } else if (data.LiteralBool) {
        return new LiteralBool(manager);
    } else if (data.LiteralInt) {
        return new LiteralInt(manager);
    } else if (data.LiteralNull) {
        return new LiteralNull(manager);
    } else if (data.LiteralReal) {
        return new LiteralReal(manager);
    } else if (data.LiteralString) {
        return new LiteralString(manager);
    } else if (data.LiteralUnlimitedNatural) {
        return new LiteralUnlimitedNatural(manager);
    } else if (data.Package) {
        return new Package(manager);
    } else if (data.PrimitiveType) {
        return new PrimitiveType(manager);
    } else if (data.Profile) {
        return new Profile(manager);
    } else if (data.Property) {
        return new Property(manager);
    } else if (data.Realization) {
        return new Realization(manager);
    } else if (data.Slot) {
        return new Slot(manager);
    } else if (data.Stereotype) {
        return new Stereotype(manager);
    } else if (data.Usage) {
        return new Usage(manager);
    } else if (data.Interface) {
        return new Interface(manager);
    } else if (data.Signal) {
        return new Signal(manager);
    }
}

export default async function parse(data, manager) {
    const ret = parseType(data, manager);
    if (data.Abstraction) {
