...
export function assignRedefinableElementSets(redefinableElement) {
    ...
    redefinableElement.sets['redefinedElements'] = redefinableElement.redefinedElements;
    redefinableElement.sets['redefinitionContexts'] = redefinableElement.redefinitionContexts;
}
