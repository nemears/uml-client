...
import { ENUMERATION_LITERAL_ENUMERATION_ID, ENUMERATION_OWNED_LITERALS_ID } from "../modelIds.js";

export default class Enumeration extends DataType {

    constructor(manager) {
        super(manager);
        this.typeInfo = new TypeInfo('Enumeration');
        ...
        this.ownedLiterals = new UmlSet(this, ENUMERATION_OWNED_LITERALS_ID);
