...
import StructuralFeature from "./structuralFeature.js";
import { assignConnectableElement } from './connectableElement.js';
...
export default class Property extends StructuralFeature {
    constructor(manager) {
        ...
        this.propertyTypeInfo = new TypeInfo(PROPERTY_ID, 'Property');
